...
export const alt = "Carlos Azaustre — Desarrollo Web & JavaScript";
    ...
    (
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 30, fontWeight: 700, color: "#1a1a1a", lineHeight: 1.3, marginTop: "16px", display: "flex", flexWrap: "wrap", opacity: 0.75 }}>
            Ingeniero de Software · Google Developer Expert · Creador de contenido
          </div>
        </div>
