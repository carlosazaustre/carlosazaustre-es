...
related:
  ...
  - google-cloud-run
seoTitle: Desplegar Next.js SSR en Firebase Hosting
faq:
  - q: ¿Qué es Server-Side Rendering?
    a: >-
      Es cuando el servidor renderiza la página y la envía al cliente,
      reduciendo el tiempo de carga frente al renderizado en el navegador.
  - q: ¿Qué necesitamos?
    a: >-
      Para este tutorial voy a utilizar Next.js, mi framework favorito para
      crear aplicaciones web. Para ello vamos a crear una aplicación de ejemplo
      con el comando create-next-app&#58;
---
