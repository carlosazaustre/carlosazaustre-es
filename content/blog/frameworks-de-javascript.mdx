...
seoTitle: 'Frameworks JavaScript: cuál elegir'
faq:
  - q: ¿Aplicaciones web híbridas?
    a: >-
      El auge de las aplicaciones móviles, Android e iOS, hizo que algunos
      frameworks evolucionaran y aparecieran nuevas herramientas. En un momento
      había muchas herramientas que permitían que una web pudiera ser
      empaquetada como una app mobile (Phonegap), pero la experiencia de usuario
      y el uso era un infierno.
  - q: ¿Qué pasa con Angular?
    a: >-
      Angular era dominante pero React le ha ido ganando terreno. Con React
      Native y ECMAScript6 cubriendo lo que Angular aportaba, su relevancia está
      disminuyendo.
  - q: Entonces ¿Qué elijo?
    a: >-
      Elige la herramienta con la que te sientas más cómodo y te haga más
      productivo. Olvídate de modas. Prueba lo que te llame la atención y, si lo
      ves útil, adelante.
---
