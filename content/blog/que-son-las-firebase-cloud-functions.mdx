...
faq:
  - q: ¿Qué puedo hacer con las Cloud Functions?
    a: >-
      Puedes enviar notificaciones push, filtrar y sanitizar mensajes de la base
      de datos, y procesar imágenes, combinando triggers de Firebase con Cloud
      Functions.
  - q: ¿Cómo creo mi primera Cloud Function?
    a: >-
      Instala Node.js y NPM, luego firebase-tools. Autentícate con Google,
      ejecuta firebase init con la opción functions y escribe tu función en
      functions/index.js.
---
