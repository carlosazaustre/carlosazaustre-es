...
related:
  ...
  - lazy-loading-image
faq:
  - q: ¿Qué es Mobile First?
    a: >-
      Mobile First es una técnica de diseño que consiste en comenzar por un
      diseño adaptado a smartphones y añadir funcionalidades y estilos conforme
      aumenta el tamaño del navegador.
  - q: ¿Es tu página Mobile Friendly?
    a: >-
      Google ofrece la herramienta Mobile Friendly Test para comprobarlo.
      Introduce la URL y te indica si cumple los requisitos o qué errores
      corregir.
  - q: ¿Afecta la velocidad de carga a nuestra web?
    a: >-
      Sí, afecta tanto al SEO como a la experiencia de usuario. Una carga lenta
      hace que los visitantes abandonen la web. Google valora el rendimiento y
      lo tiene en cuenta en su algoritmo de búsqueda.
---
