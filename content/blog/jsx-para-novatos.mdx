...
faq:
  - q: Por qué React necesita crear elementos
    a: >-
      React al basar el desarrollo de apps en componentes, necesitamos crear
      elementos HTML que definan nuestro componente, por ejemplo , , , etc...
      También necesitaremos indicar cuando se trata de componentes creados por
      nosotros con React, como puede ser un , , etc...
  - q: Cómo utilizar JSX en tu proyecto
    a: >-
      Para poder utilizar JSX, necesitarías añadir una librería extra a tu HTML,
      pero es más aconsejable utilizar un bundler integrado en tu entorno de
      desarrollo, como puede ser WebPack o Browserify, y que éste le aplique la
      transformación antes de publicar
---
